...
#define TESTS_FIBONACCI 14
#define TESTS_CHESS_RECTANGLE 5
#define TESTS_BINOMIAL 23
#define TESTS_TRICKY 13
...
static exercise_binomial_data exercise_binomial [TESTS_BINOMIAL] = {
        ...
        {.n = 3, .k = 3, .expected = 1},
        {.n = 13, .k = 0, .expected = 1},
        {.n = 31, .k = 13, .expected = 206253075},
        {.n = 32, .k = 16, .expected = 601080390},
